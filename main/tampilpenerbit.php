                ...
                <main>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <a href="penerbit.php" class="btn btn-primary">Tambah Data</a>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="editpenerbit.php?id=<?php echo $ambil_data['id_penerbit']; ?>" class="btn btn-warning">Edit</a>
                                                <a href="hapuspenerbit.php?id=<?php echo $ambil_data['id_penerbit']; ?>" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
