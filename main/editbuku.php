<?php
    include "navbar.php";
    $ambil_data = $_GET['id'];
    $sql = "SELECT * FROM buku WHERE id_penulis = $ambil_data";
...
while ($data = mysqli_fetch_array($query)) {
    ...
    ?>                              
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput2" name="id_penerbit" value="<?php echo $data['id_penerbit'] ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="formGroupExampleInput2" class="form-label">Nama Penerbit</label>
                                        <input type="text" class="form-control" id="formGroupExampleInput2" name="nama_penerbit" value="<?php echo $data['nama_penerbit'] ?>">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput2" name="link" value="<?php echo $data['link'] ?>">
