                ...
                <main>
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <a href="buku.php" class="btn btn-primary">Tambah Data</a>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="editbuku.php?id=<?php echo $ambil_data['id_penulis']; ?>" class="btn btn-warning">Edit</a>
                                                <a href="hapusbuku.php?id=<?php echo $ambil_data['id_penulis']; ?>" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
