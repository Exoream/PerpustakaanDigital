                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <?php
                                            if(isset($_GET['cari'])){
                                                ...
                                                $query = mysqli_query($koneksi, "select * from login_admin where username like '%$keyword%'");
                                            }else{
                                                $query = mysqli_query($koneksi, "select * from login_admin");
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="editadmin.php?id=<?php echo $ambil_data['id_admin']; ?>" class="btn btn-warning">Edit</a>
                                                <a href="hapusadmin.php?id=<?php echo $ambil_data['id_admin']; ?>" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                        <?php
                                            }
                                        ?>
